...
import com.maurinem.classroommanager.dao.StudentDAO;
import com.maurinem.classroommanager.model.Person;
import com.maurinem.classroommanager.model.Student;
import com.maurinem.classroommanager.util.*;
...
public class SendText extends Window {
	...
	protected void initComponents() {
								...
								.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
										.addGroup(GroupLayout.Alignment.TRAILING,
												layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
														.addComponent(messageScroller, GroupLayout.DEFAULT_SIZE, 376,
																Short.MAX_VALUE)
						...
						.addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
								...
								.addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
										.addGroup(layout.createSequentialGroup()
												...
												.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(studentsScroller, GroupLayout.PREFERRED_SIZE, 0,
														Short.MAX_VALUE))
										.addGroup(layout.createSequentialGroup()
												.addComponent(recipientsScroller, GroupLayout.DEFAULT_SIZE, 69,
														Short.MAX_VALUE)
												.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(messageScroller, GroupLayout.PREFERRED_SIZE, 182,
		...
		messageTextArea.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent me) {
				previewPopup(me, "Preview Text", messageTextArea);
			}
		});
	}
	...
	private void sendBtnMouseClicked(MouseEvent me) {
		...
		for (int i : students.keySet()) {
			Executors.newSingleThreadExecutor()
					.execute(new SendTextMessage(students.get(i), messageTextArea.getText()));
		}
