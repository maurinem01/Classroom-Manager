...
/**
 * This extension of DefaultTableModel is used for the left pane in the windows
 * listing all students in the database. The contents of this model need to be
 * accessed by index and by key.
 * 
 * @author Maurine
 */
