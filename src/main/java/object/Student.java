...
public class Student extends Person {
	...
	/* These IDs identifies the priority of the student on the checkedInList in windows.Checkin.*/
	...
	/* Organizes priorities within main groups but not used for sorting in windows.Checkin.  Negative number puts it to higher priority */
	...
	public Student(Student s) {
		...
		this.timeOut = subjectID == Subject.ALL ? 
				LocalDateTime.now().plusMinutes(Config.SESSION_LENGTH * 2) : 
	...
	public String getSubject() {
		switch (this.subjectID) {
			...
			case Subject.ALL:return "Math & Reading";
	...
	public void setNotesExpiryDate(LocalDateTime notesExpiryDate) { this.notesExpiryDate = notesExpiryDate; }
	
	public LocalDateTime getNotesExpiryDate() { return notesExpiryDate; }
	
	public String displayTimeIn() { return timeFormat.format(timeIn); }
	
	public String displayTimeOut() { return timeFormat.format(timeOut); }
	...
	public boolean isActive() { return signedIn; }
	
	public void setContactPhones(String[] contactPhones) { this.contactPhones = contactPhones; }
	...
	public String[] birthday() { return birthday.split("-"); }
	...
	public Contact getContact(int relationshipID) { 
		assert (relationshipID == Contact.ONE || relationshipID == Contact.TWO) : "Relationship ID must be one of Contact.ONE or Contact.TWO";
		return contacts.get(relationshipID); 
	}
	
	public boolean isBirthdayToday() {
		return birthday != null && birthday.length() > 0 ? birthday.substring(0,5).equals(birthdayFormat.format(LocalDateTime.now())) : false;			
//		return birthday != null && birthday.length() > 0 && birthday.substring(0,5).equals(birthdayFormat.format(LocalDateTime.now()));			// More elegant but less legible????
	}
	
	public int daysUntilBirthday() {
//		String birthdayStr = birthday != null && birthday.length() > 0 ? birthday.substring(0,5) : "";
	...
	public void checkAppointment() {
		Executors.newSingleThreadExecutor().execute(() -> {
			...
			try {
				...
				student.setOnTime(appointment != null && log.onTime(appointment));
	...
	@Override
	public String toString() { return getName() + " - " + getSubject(); }
...
/////////////////////////////////////////////////////////////////////
	...
	@Override
	public int hashCode() { return 10000 + id; }
