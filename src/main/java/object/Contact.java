...
public class Contact extends Person {
	...
	public boolean getAllowNotifications() { return this.allowNotifications; }
	...
	@Override
	public int hashCode() { return 20000 + id; }
...
///// METHODS BELOW HERE ARE USED FOR ContactProcessor /////
	...
	/** Used for ContactProcessor */
	public void setNotifications(int notifications) { this.tempNotifications = notifications; }
	/** Used for ContactProcessor */
	public int getNotifications() { return tempNotifications; }
