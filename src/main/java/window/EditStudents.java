...
public class EditStudents extends Window{
	...
	/** ArrayList for right pane table -- purpose is to access data by index rather than key*/
    ...
    protected void initComponents() {
        ...
        studentInformation.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Student Information", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION));
            ...
            .addGroup(studentInformationLayout.createSequentialGroup()
                ...
                .addGroup(studentInformationLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(studentInformationLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(studentNotesTextField, GroupLayout.PREFERRED_SIZE, 325, GroupLayout.PREFERRED_SIZE))
                    .addGroup(studentInformationLayout.createSequentialGroup()
                        .addGroup(studentInformationLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addGroup(studentInformationLayout.createSequentialGroup()
                            ...
                            .addGroup(studentInformationLayout.createSequentialGroup()
                                ...
                                .addComponent(studentNotesExpiryTextField, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(studentNotesExpiryDateLabel, GroupLayout.PREFERRED_SIZE, 85, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(studentTagLabel)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(studentTagTextField, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(studentTagComboBox, GroupLayout.PREFERRED_SIZE, 92, GroupLayout.PREFERRED_SIZE)))
        ...
        studentInformationLayout.setVerticalGroup(
            ...
            .addGroup(studentInformationLayout.createSequentialGroup()
                ...
                .addGroup(studentInformationLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                    .addComponent(studentFirstNameTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(studentFirstNameLabel))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(studentInformationLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(studentLastNameLabel)
                    .addComponent(studentLastNameTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(studentInformationLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(studentBirthdayLabel)
                    .addComponent(studentBirthdayYear, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(studentBirthdayMonth, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(studentBirthdayDay, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(studentInformationLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(studentSubjectLabel)
                    .addComponent(studentSubjectMath)
                ...
                .addGroup(studentInformationLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(studentNotesLabel)
                    .addComponent(studentNotesTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(studentInformationLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(studentNotesExpiryLabel)
                    .addComponent(studentNotesExpiryTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(studentTagLabel)
                    .addComponent(studentTagTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(studentNotesExpiryDateLabel)
                    .addComponent(studentTagComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addContainerGap(12, Short.MAX_VALUE))
        );

        contactInformation.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Contact Information", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION));
        ...
        contact1Layout.setVerticalGroup(
            ...
            .addGroup(contact1Layout.createSequentialGroup()
                ...
                .addGroup(contact1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(cFirstNameLabel1)
                    .addComponent(cFirstNameTextField1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(contact1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(cLastNameLabel1)
                    .addComponent(cLastNameTextField1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(contact1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(cCellNumberLabel1)
                    .addComponent(cCellNumberTextField1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(contact1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(cEmailLabel1)
                    .addComponent(cEmailTextField1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cNotificationsCheckBox1)
        ...
        contact2Layout.setVerticalGroup(
            ...
            .addGroup(contact2Layout.createSequentialGroup()
                ...
                .addGroup(contact2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(cFirstNameLabel2)
                    .addComponent(cFirstNameTextField2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(contact2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(cLastNameLabel2)
                    .addComponent(cLastNameTextField2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(contact2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(cCellNumberLabel2)
                    .addComponent(cCellNumberTextField2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(contact2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(cEmailLabel2)
                    .addComponent(cEmailTextField2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cNotificationsCheckBox2)
                .addContainerGap(7, Short.MAX_VALUE))
        );
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                            .addComponent(studentInformation, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(studentInformation, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
		...
		studentsTable.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent me) { selectStudent(); }
		});
        ...
        studentNotesExpiryTextField.getDocument().addDocumentListener(new DocumentListener() {
			@Override
			public void insertUpdate(DocumentEvent e) { updateDate(); }
			@Override
			public void removeUpdate(DocumentEvent e) { }
			@Override
			public void changedUpdate(DocumentEvent e) { updateDate(); }
        });
        ...
        saveButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent me) { 
				...
				try {
					if ((studentFirstNameTextField.getText().trim().isEmpty()) || (studentLastNameTextField.getText().trim().isEmpty())) {
						validSave = false;
					...
					if (studentBirthdayYear.getSelectedIndex() != 0 && studentBirthdayMonth.getSelectedIndex() != 0 && studentBirthdayDay.getSelectedIndex() != 0)
						birthday = studentBirthdayMonth.getSelectedItem() + "-" + studentBirthdayDay.getSelectedItem() + "-" + studentBirthdayYear.getSelectedItem();
					else {
						validSave = false;
					...
					if (validSave) {
						...
						if (newStudent) {
							// THIS IS WHERE I AM
							newStudentEntry = new Student(tag, studentFirstNameTextField.getText(), studentLastNameTextField.getText(), birthday, subjectSelected, notes, LocalDateTime.now(), studentIndicatorID);
							studentDAO.create(newStudentEntry);
							JOptionPane.showMessageDialog(null, "Entry created for " + studentFirstNameTextField.getText() + " " + studentLastNameTextField.getText() + ".", 
									"New Entry", JOptionPane.INFORMATION_MESSAGE);
						} else { 
							if (!studentNotesExpiryDateLabel.getText().trim().isEmpty()) {
								String dateTime = studentNotesExpiryDateLabel.getText() + " 00:00" ; // set expiry to 00:00 of notesExpiryDateLabel.getText()
				...
				if (newStudent) {
					System.out.println("Created contact for new student " + studentFirstNameTextField.getText() + " " + studentLastNameTextField.getText());
					createContact(cFirstNameTextField1, cLastNameTextField1, cCellNumberTextField1, cEmailTextField1, cNotificationsCheckBox1, newStudentEntry.getID(), Contact.ONE);
					createContact(cFirstNameTextField2, cLastNameTextField2, cCellNumberTextField2, cEmailTextField2, cNotificationsCheckBox2, newStudentEntry.getID(), Contact.TWO);
				} else  {
					if (activeStudent.getContact(Contact.ONE) == null) { 
						System.out.println("Trying to create contact 1 for existing student");
						createContact(cFirstNameTextField1, cLastNameTextField1, cCellNumberTextField1, cEmailTextField1, cNotificationsCheckBox1, activeStudent.getID(), Contact.ONE);
					}
					if (activeStudent.getContact(Contact.TWO) == null) {
						System.out.println("Trying to create contact 2 for existing student");
						createContact(cFirstNameTextField2, cLastNameTextField2, cCellNumberTextField2, cEmailTextField2, cNotificationsCheckBox2, activeStudent.getID(), Contact.TWO);
					}
					if (activeStudent.getContact(Contact.ONE) != null) {
						System.out.println("Updated contact 1 for existing student");
						updateContact(c1, cFirstNameTextField1, cLastNameTextField1, cCellNumberTextField1, cEmailTextField1, cNotificationsCheckBox1);
					}
					if (activeStudent.getContact(Contact.TWO) != null) {
						System.out.println("Updated contact 2 for existing student");
						updateContact(c2, cFirstNameTextField2, cLastNameTextField2, cCellNumberTextField2, cEmailTextField2, cNotificationsCheckBox2);
					}
				}
				...
				if (validSave) {
					...
					if (!newStudent)
						JOptionPane.showMessageDialog(null, "Entry updated for " + studentFirstNameTextField.getText() + " " + studentLastNameTextField.getText() + ".", 
        ...
        newStudentButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent me) { emptyFields(); }
		});
        ...
        removeStudentButton.addMouseListener(new MouseAdapter() {
        	...
        	public void mousePressed(MouseEvent me) {             	
            	try {
        	    	if (studentsTable.getSelectedRowCount() > 0) {
        	    		Student selectedStudent = allStudentsList.get(studentsTable.convertRowIndexToModel(studentsTable.getSelectedRow()));
        	    		System.out.println(selectedStudent.getID() + " - " + selectedStudent.getName() + " ");
        	    		int delete = JOptionPane.showConfirmDialog(null, "Are you sure you want to remove " + selectedStudent.getName() + "?", "Delete Confirmation", JOptionPane.YES_NO_OPTION);
        	    		if (delete == JOptionPane.YES_OPTION) {
        	    			new StudentDAO().delete(selectedStudent.getID());	// MySQL will handle deleting entries from log and contact
        	    			JOptionPane.showMessageDialog(null, "Deleted entry for " + selectedStudent.getName() + ".");
        	    		}
        	    	} else {
        	    		JOptionPane.showMessageDialog(null, "Select a student to delete.", "No Selection", JOptionPane.WARNING_MESSAGE);
    ...
    private void selectStudent() {
		...
		try {
			...
			if (activeStudent.getNotes() != null && !activeStudent.getNotes().trim().isEmpty()) { // display notes + expiry
				...
				studentNotesExpiryTextField.setText((ChronoUnit.DAYS.between(LocalDateTime.now(), activeStudent.getNotesExpiryDate()) 
								+ ((activeStudent.getNotesExpiryDate().isAfter(LocalDateTime.now())) ? 1 : 0)) // make 2nd parameter inclusive if > 0
								+ ""); 				// convert to String
			...
			if (activeStudent.getContact(Contact.ONE) != null) {
				...
				fillContact(c1, cFirstNameTextField1, cLastNameTextField1, cCellNumberTextField1, cEmailTextField1, cNotificationsCheckBox1);
			}
			
			if (activeStudent.getContact(Contact.TWO) != null) {
				c2 = activeStudent.getContact(Contact.TWO);
				fillContact(c2, cFirstNameTextField2, cLastNameTextField2, cCellNumberTextField2, cEmailTextField2, cNotificationsCheckBox2);
			}
    ...
    private void fillContact(Contact c, JTextField firstNameField, JTextField lastNameField, JTextField phoneField, JTextField emailField, JCheckBox notificationBox) {
	...
	private void updateContact(Contact contact, JTextField firstNameField, JTextField lastNameField, JTextField phoneField, JTextField emailField, JCheckBox notificationsBox) {
		...
		try {
			if (contact != null) { // If contact already exists
				...
				} else if ((firstNameField.getText().trim().isEmpty()) && (lastNameField.getText().trim().isEmpty()) && (phoneField.getText().trim().isEmpty()) && (emailField.getText().trim().isEmpty()))  {
	...
	/** If the first and last name fields of the contact fields are filled, a new contact entry will be added to the database */
	private void createContact(JTextField firstNameField, JTextField lastNameField, JTextField phoneField, JTextField emailField, JCheckBox notificationsBox, int studentID, int relID) {
		ContactDAO contactDAO = new ContactDAO();
		try {
			if (!(firstNameField.getText().trim().isEmpty()) && !(lastNameField.getText().trim().isEmpty())) {
				...
				contactDAO.create(new Contact(firstNameField.getText(), lastNameField.getText(), phone, email, notifications, studentID, relID));
			}			
		} catch (ProgramException e) {
			System.err.println(e);
		} catch (Exception e) {
