...
public class StudentTableList {
	...
	public void listListener(MouseEvent me, Map<Integer, Student> map, JList<Student> list, ProgramStudentsListModel listModel, DefaultTableModel tableModel) { // I wanted to call this LISTener but that's confusing xD
	...
	public void addStudent(MouseEvent me, List<Student> studentList, JTable table, ProgramStudentsListModel listModel, DefaultTableModel tableModel) {
		if (me.getClickCount() == 2 && me.getButton() == MouseEvent.BUTTON1) {
