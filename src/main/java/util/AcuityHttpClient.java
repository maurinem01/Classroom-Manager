...
// */
// public static Appointment getAppointment(LocalDateTime dateTime, String
// firstName, String lastName)
// throws IOException, InterruptedException {

// String date = dateTime.getMonth() + " " + dateTime.getDayOfMonth() + ", " +
// dateTime.getYear();
...
// List<Appointment> appointments = mapper.readValue(response.body(), new
// TypeReference<List<Appointment>>() {
// });
...
// public static Appointment getAsyncAppointment(LocalDateTime dateTime, String
// firstName, String lastName) {
// String date = dateTime.getMonth() + " " + dateTime.getDayOfMonth() + ", " +
// dateTime.getYear();
// ObjectMapper mapper = new ObjectMapper();
...
// .thenAccept(res -> {
// try {
// appointments = mapper.readValue(res.getResponseBody(), new
// TypeReference<List<Appointment>>() {
// });
...
// return appointments != null && appointments.size() > 0 ? appointments.get(0)
// : null;
// }
