...
/**
 * Keep all system configuration properties in one class without needing to connect to database every time a property needs to be retrieved.
 * This class is meant to hold all system configurations in a static manner and cannot be sub-classed.
 * @author Maurine
 *
 */
public final class Config {
	...
	/** Credentials */
	public static final Map<String, String> getCredentials() { return credentials; }
	...
	/** System's time format. (See {@link dao.ConfigDAO#timeFormat} for more information) */
	public static final String TIME_FORMAT = config.getTimeFormat();
		
	/** System setting for one subject session length. (See {@link dao.ConfigDAO#sessionLength} for more information)  */
	public static final int SESSION_LENGTH = config.getSessionLength();
	
	/** System setting for warning time for subject change or dismissal. (See {@link dao.ConfigDAO#warningTime} for more information)  */
