...
public class SorterFilter implements DocumentListener {
	...
	@Override
	public void insertUpdate(DocumentEvent de) { filter(de); }

	@Override
	public void removeUpdate(DocumentEvent de) { filter(de); }

	@Override
	public void changedUpdate(DocumentEvent de) { filter(de); }
